...
#define EIGENVALUE_L 0.8 //smallest eigenvale
#define EIGENVALUE_H 8.0 //largest eigenvalue
#define CONDITION_NUMBER 10.00 //condition number is EIGENVALUE_H/EIGENVALUE_L.
#define Q_S 1.0
#define R_S 1.0
